/* =============================================================
   expenses.js
   Expense object code repository, scoped by department. The UI
   only ever talks to this module (never to GoogleSheets directly).

   Exposes: window.BudgetApp.Expenses
   Depends on: window.BudgetApp.GoogleSheets
   ============================================================= */

window.BudgetApp = window.BudgetApp || {};

window.BudgetApp.Expenses = (function (GoogleSheets) {
  'use strict';
